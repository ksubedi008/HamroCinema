      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh] px-4">
          ...
          >
            ...
            >
              <div className="flex items-center px-4 border-b border-zinc-800" cmdk-input-wrapper="">
                ...
                />
                <div className="text-xs font-mono px-2 py-1 bg-white/10 rounded text-gray-400 border border-zinc-800">ESC</div>
              </div>
