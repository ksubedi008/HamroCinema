          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
            ...
            {movies.filter(movie => movie.status === 'Now Showing' && movie.is_active).length === 0 && (
              ...
              >
                ...
                <Link to="/cinema-hq-99x/movies" className="px-6 py-2 rounded-full bg-white/10 hover:bg-white/20 text-white font-medium transition-colors border border-zinc-800">
