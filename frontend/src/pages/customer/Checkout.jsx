                ...
                <div className="bg-zinc-950 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-8 border-t border-zinc-800 text-center">
                        ...
                        <button 
                            ...
                            className={`btn-premium w-full bg-[#60bb46] hover:bg-[#52a33b] text-white font-bold py-3 px-6 rounded-lg flex justify-center items-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {isSubmitting ? (
                                <>
