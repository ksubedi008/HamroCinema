        ...
        <div className="w-full pb-20 pt-12 animate-fade-in relative z-10 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="bg-zinc-900  border border-zinc-800 rounded-3xl p-8 md:p-12 shadow-2xl space-y-10 text-gray-300 leading-relaxed font-medium">
                ...
                <section className="space-y-4 pt-8 border-t border-zinc-800">
                    ...
                    <p>
                        For any legal inquiries or questions regarding these Terms of Service, please reach out to our legal department at <a href="mailto:legal@hamrocinema.com" className="text-rose-500 hover:text-rose-500 transition-colors">legal@hamrocinema.com</a>.
                    </p>
                </section>
            </div>
        </div>
